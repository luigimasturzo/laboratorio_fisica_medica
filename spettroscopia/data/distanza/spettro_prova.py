...
def sottrazione_fondo(file_path,source_path):
   ...
   t_source = 1541.719966          #tempo exp. sorgente
   t_fondo = 51600.458847         #tempo exp. fondo         
   data=(t_source/t_fondo)*data

   #cancella poi, serve solo per scalare il file da 30 cm nelle distanze
   '''t_sorgente_prova=6622
   ...
   area=covell(10,890,980,data_fin)
